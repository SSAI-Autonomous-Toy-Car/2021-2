...
MM1_MAX_FORWARD = 1650      # Max throttle to go fowrward. The bigger the faster
...
# -- Google coral: '/dev/ttymxc0'sudo udevadm control --reload-rules
...
#This is used to create a tcp service to pushlish the feed
